...
parser.add_argument('--data', '-d', help = 'file with path of the pickle data e.g. d3_XXX/')
parser.add_argument('--batch', '-b', default=10, type=int, help = 'batch size, not including rotation data. e.g. batch=10 => 10x8 used for training')
parser.add_argument('--epoch', '-e', default=100, type=int, help = 'epoch')
parser.add_argument('--start', '-st', default=1, type=int, help = 'Begining epoch value')
parser.add_argument('--modelG', '-mg', help = 'Saved modelG if present')
parser.add_argument('--modelD', '-md', help = 'Saved modelD if present')
...
parser.add_argument('--shape', '-sh',default='2,11', type=str, help = 'tensor shape of mass spectrum e.g 100,150')
parser.add_argument('--fbatch', '-fb', default=2, type=int, help = 'batch size of files. e.g. fbatch=3 => 3 files import once from --data')
...
parser.add_argument('--noise', '-n',default=0, type=float, help = 'Rate of 1 in noise. 0 = no noize')
parser.add_argument('--noisemin', '-nmi', default=0.5, type=float, help = '')
parser.add_argument('--noisemax', '-nma', default=2.0, type=float, help = '')
parser.add_argument('--test', '-t', help = 'file with path of the pickle for test') ######
